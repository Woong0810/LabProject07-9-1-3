...
void CCamera::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	XMMATRIX xmmtxViewProjection = XMLoadFloat4x4(&m_xmf4x4View) * XMLoadFloat4x4(&m_xmf4x4Projection);
	XMStoreFloat4x4(&xmf4x4ViewProjection, XMMatrixTranspose(xmmtxViewProjection));
	::memcpy(&m_pcbMappedCamera->m_xmf4x4ViewProjection, &xmf4x4ViewProjection, sizeof(XMFLOAT4X4));
