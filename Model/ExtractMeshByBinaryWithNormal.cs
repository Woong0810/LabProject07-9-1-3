...
public class ExtractMeshByBinaryWithNormal : MonoBehaviour
{
    ...
    void WriteMeshInfo(string strHeader, Mesh mesh)
    {
        WriteObjectName(strHeader, mesh.vertexCount, mesh);
    ...
    void WriteFrameInfo(Transform current)
    {
        if (current.gameObject.activeSelf)
        {
            ...
            {
                WriteMeshInfo("<Mesh>:", meshFilter.sharedMesh);
            ...
            else
            {
                ...
                if (skinMeshRenderer)
                {
                    WriteMeshInfo("<SkinnedMesh>:", skinMeshRenderer.sharedMesh);
